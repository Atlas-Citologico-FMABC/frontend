...
class DiretoriosTab extends StatefulWidget {
  final void Function(
  ...
  const DiretoriosTab({super.key, required this.openDirectory});

  @override
  State<DiretoriosTab> createState() => _DiretoriosTabState();
}

class _DiretoriosTabState extends State<DiretoriosTab> {
